...
class _MessageState extends State<Message> {
  ...
  final Future<FirebaseApp> _future = Firebase.initializeApp(options: DefaultFirebaseOptions.currentPlatform,);

  void addData(String mensagem) {
    databaseRef.push().set({'id_usuario': usuario.id, 'conteudo': mensagem, "data": DateTime.now().toString(), "id_condominio": condominio.id});
  }
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(
                          left: 6, top: 20, right: 16, bottom: 12),
                      ...
                      child:
                      Text('Olá, boa tarde! Como vai a obra na portaria?'),
                    ),
                  ],
                ),
                Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Text(
                        'Boa tarde, está prevista para terminar no dia 08/07!',
                ...
                Row(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      radius: 20,
                      backgroundImage: NetworkImage(
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRF8Bw4y9R76MiSmK94b9l36dfkC45hCRPJug&usqp=CAU'),
                    ),
                    Container(
                      padding: EdgeInsets.all(12),
                      margin: EdgeInsets.only(
                          left: 6, top: 10, right: 16, bottom: 12),
                      constraints: BoxConstraints(maxWidth: 200),
                      decoration: BoxDecoration(
                          color: Colors.grey[300],
                          borderRadius: BorderRadius.only(
                              bottomRight: Radius.circular(10))),
                      child: Text(
                          'Existe alguma possibilidade de antecipar essa data?'),
                    ),
                  ],
                ),
                Row(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.only(
                              bottomLeft: Radius.circular(10))),
                      child: Text(
                        'No momento não, pois a empresa contratada está com número de funcionários limitada!',
                        style: TextStyle(color: Colors.white),
                      ),
                    ),
                  ],
                ...
                Row(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      radius: 20,
                      backgroundImage: NetworkImage(
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYdJUMyMHaTcXC8CQl2MizgsHFLNpq8DuLYMdaZ-kUEXl6rXZ-Kuu-BMZmc34_x5CCfzk&usqp=CAU'),
                    ),
                    Container(
                      padding: EdgeInsets.all(12),
                      margin: EdgeInsets.only(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.only(
                              bottomRight: Radius.circular(10))),
                      child: Text(
                          'Espero que acabe no prazo estipulado, pois já está dando muita dor de cabeça.'),
                    ),
                  ],
                ),
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.only(
                              bottomRight: Radius.circular(10))),
                      child: Text('Pois é, além de ter saído muito caro!'),
                    ),
                  ],
                ),
                Row(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.only(
                              bottomLeft: Radius.circular(10))),
                      child: Text(
                        'Podem ficar tranquilos que tudo será resolvido até a data estipulada!',
                        style: TextStyle(color: Colors.white),
                      ),
                    ),
                  ],
